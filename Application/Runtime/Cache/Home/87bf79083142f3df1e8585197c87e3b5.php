		...
		<div class="row">
  		...
  		<div class="row">
  			...
  			<div class="col-md-8" id="info">
				...
				<div class="col-md-2">
					<table class="table table-hover">
						<tr><th><input class="input-block-level" type="text" placeholder="500元/月" id="rent"></th></tr>
						<tr><td><input class="input-block-level" type="text" placeholder="三室一厅" id="department"></td></tr>
					</table>
				</div>
  			</div>
  		</div>
