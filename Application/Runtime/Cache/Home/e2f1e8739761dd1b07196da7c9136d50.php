				...
				<form class="form-horizontal" role="form" action="/index.php/Home/Index/insert" method="post">
					<div class="form-group" id="demail">
					   ...
					   <div class="col-md-6">
   					   	   ...
   					   	   <span class="help-block" style="display: none;" id="pemail">邮箱格式错误</span>
   					   	   <span class="help-block" style="display: none;" id="pemail1">邮箱不能为空</span>
   					   	   <span class="help-block" style="display: none;" id="pemail2">请填写正确的邮箱地址</span>
   					   </div>
					</div>
					<div class="form-group" id="dname">
					    ...
					    <div class="col-md-6">
					      ...
					      <span class="help-block" style="display: none;" id="pname">用户名格式错误</span>
					      <span class="help-block" style="display: none;" id="pname1">用户名应由汉字，字母和数字组成</span>
					    </div>
					</div>
